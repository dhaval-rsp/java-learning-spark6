...
3. no output cannot be changed because for child thread the print statement is in order and for main thread we have used join statement which means it will wait for download/child thread to finish its work then proceed to print main thread stament
